  ...
  <div class="page">
    ...
    <section v-if="!loading" class="products">
      ...
      <div class="products-container">
        <template v-if="mainDishProducts.length > 0">
          <div
            v-for="product in mainDishProducts"
            :key="product.id"
            class="product-box"
        ...
        <div v-else class="empty-products">
          ...
          <p>No main dish products available at the moment.</p>
        </div>
      </div>
    </section>
...
// Computed: Filter main dish products
const mainDishProducts = computed(() => {
  return products.value.filter(
    (product) => product.category === 'main-dish'
  )
})
