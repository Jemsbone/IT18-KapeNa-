  ...
  <div class="page">
    ...
    <section v-if="!loading" class="products">
      ...
      <div class="products-container">
        <template v-if="drinkProducts.length > 0">
          <div
            v-for="product in drinkProducts"
            :key="product.id"
            class="product-box"
        ...
        <div v-else class="empty-products">
          <i class="fas fa-glass-martini-alt empty-icon"></i>
          <p>No drink products available at the moment.</p>
        </div>
      </div>
    </section>
...
// Computed: Filter drink products
